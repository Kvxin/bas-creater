...
export const MENU_REGISTRY: Record<string, MenuConfig> = {
  'track-header': {
    ...
    items: [
      ...
      { id: 'del', label: '删除轨道', action: 'track.delete', class: 'text-destructive' }
    ]
  },
  'timeline-clip': {
    label: '片段操作',
    items: [
      ...
      { id: 'del', label: '删除', action: 'clip.delete', class: 'text-destructive' }
    ]
  },
  'timeline-bg': {
    label: '时间轴',
  ...
  'resource-item': {
    ...
    items: [
      ...
      { id: 'sep2', separator: true, label: '' },
      { id: 'del', label: '删除', action: 'resource.delete', class: 'text-destructive' }
    ]
  }
}
